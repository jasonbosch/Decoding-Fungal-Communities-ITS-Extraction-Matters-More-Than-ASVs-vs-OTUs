# source("X_Analyse_Data_V6_V8_GABRI_NEW.R")
...
final_res <- paste0(root_path, "final_analysis_results_V6_V8/")
...
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/all_alpha_divs.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/all_phylos.Rds"))
#full_taxonomy <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/full_taxonomy_ready.Rds"))
#physeq_combined <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_combined.Rds"))
#physeq_FWD_ASV <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_FWD_ASV.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_FWD_ASV_Rolling.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_FWD_OTU.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_ITS_ASV.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_ITS_ASV_Rolling.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_ITS_OTU.Rds"))
#physeq_true <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/physeq_true.Rds"))
#Similarity_scores_2 <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/similarity_scores.Rds"))
#true_community <- readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/true_community_final_clean.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_V6_V8_new/true_tax_table.Rds"))

#setwd("~/PostDoc/02_Projects/06_ASV_OTU_Comparison/04_Analysis_Results/V6_V8_new/")
...
#Import
table_FWD_ASV_Rolling_raw <- read.table(paste0(root_path, "FWD_ASV_Rolling_V6_V8_new/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_ASV_Rolling <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_ASV_Rolling_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#1 Alveolata, 16 Unassigned
physeq_FWD_ASV_Rolling <- subset_taxa(physeq_FWD_ASV_Rolling, tax_table(physeq_FWD_ASV_Rolling)[,"Kingdom"]=="Eukaryota")
...
#Import
table_FWD_ASV_raw <- read.table(paste0(root_path, "FWD_ASV_V6_V8_new/export/OTU.tsv"), 
                                 header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_ASV <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_ASV_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#1 Alveolata, 16 Unassigned
physeq_FWD_ASV <- subset_taxa(physeq_FWD_ASV, tax_table(physeq_FWD_ASV)[,"Kingdom"]=="Eukaryota")
...
#Import
table_FWD_OTU_raw <- read.table(paste0(root_path, "FWD_OTU_V6_V8_new/export/OTU-dn-97.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_OTU <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_OTU_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#2 Alveolata,3 Eukaryota_kgd_Incertae_sedis, 31 Unassigned
physeq_FWD_OTU <- subset_taxa(physeq_FWD_OTU, tax_table(physeq_FWD_OTU)[,"Kingdom"]=="Eukaryota")
...
#Import
table_ITS_ASV_Rolling_raw <- read.table(paste0(root_path, "ITS_ASV_Rolling_V6_V8_new/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_ASV_Rolling <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_ASV_Rolling_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#12 Eukaryota_kgd_Incertae_sedis, 26 Unassigned
physeq_ITS_ASV_Rolling <- subset_taxa(physeq_ITS_ASV_Rolling, tax_table(physeq_ITS_ASV_Rolling)[,"Kingdom"]=="Eukaryota")
...
#Import
table_ITS_ASV_raw <- read.table(paste0(root_path, "ITS_ASV_V6_V8_new/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_ASV <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_ASV_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#12 Eukaryota_kgd_Incertae_sedis, 26 Unassigned
physeq_ITS_ASV <- subset_taxa(physeq_ITS_ASV, tax_table(physeq_ITS_ASV)[,"Kingdom"]=="Eukaryota")
...
#Import
table_ITS_OTU_raw <- read.table(paste0(root_path, "ITS_OTU_V6_V8_new/export/OTU-dn-97.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_OTU <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_OTU_V6_V8_new/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#11 Eukaryota_kgd_Incertae_sedis, 24 Unassigned
physeq_ITS_OTU <- subset_taxa(physeq_ITS_OTU, tax_table(physeq_ITS_OTU)[,"Kingdom"]=="Eukaryota")
...
true_communities <- as.character(system("ls /mnt/cinqueg/gabriele/work/microbiology/other_analyses/jason/data/ranks_V6_V8_new/*ranks.txt",intern = T))
...
# physeq_combined <- subset_taxa(physeq_combined, tax_table(physeq_combined)[,"Kingdom"]=="Eukaryota")
...
#  geom_point (aes(colour = Replicate),position = position_jitterdodge(jitter.width = 0.1),size = 0.3)  +
#  geom_boxplot(fill=NA,size=0.3) +
#  scale_y_continuous(limits = c(-750,450), n.breaks = 6) +
#  facet_wrap(~Library_Size*Treatment,ncol = 7) +
#  labs(title = "Richness") +
...
#saveRDS(Similarity_scores_2, paste0(root_path, "final_analysis_results_V6_V8_new/similarity_scores.Rds"))
