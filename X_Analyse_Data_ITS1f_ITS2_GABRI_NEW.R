# source("X_Analyse_Data_ITS1f_ITS2_GABRI_NEW.R")
...
final_res <- paste0(root_path, "final_analysis_results_ITS1f_ITS2/")
...
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/all_alpha_divs.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/all_phylos.Rds"))
#full_taxonomy <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/full_taxonomy_ready.Rds"))
#physeq_combined <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_combined.Rds"))
#physeq_FWD_ASV <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_FWD_ASV.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_FWD_ASV_Rolling.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_FWD_OTU.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_ITS_ASV.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_ITS_ASV_Rolling.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_ITS_OTU.Rds"))
#physeq_true <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/physeq_true.Rds"))
#Similarity_scores_2 <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/similarity_scores.Rds"))
#true_community <- readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/true_community_final_clean.Rds"))
#readRDS(paste0(root_path, "final_analysis_results_ITS1f_ITS2/true_tax_table.Rds"))

#setwd("~/PostDoc/02_Projects/06_ASV_OTU_Comparison/04_Analysis_Results/ITS1f_ITS2/")
...
#Import
table_FWD_ASV_Rolling_raw <- read.table(paste0(root_path, "FWD_ASV_Rolling_ITS1f_ITS2/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_ASV_Rolling <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_ASV_Rolling_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#Import
table_FWD_ASV_raw <- read.table(paste0(root_path, "FWD_ASV_ITS1f_ITS2/export/OTU.tsv"), 
                                 header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_ASV <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_ASV_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#Import
table_FWD_OTU_raw <- read.table(paste0(root_path, "FWD_OTU_ITS1f_ITS2/export/OTU-dn-97.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_FWD_OTU <- import_qiime2_taxonomy(read.table(paste0(root_path, "FWD_OTU_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#Import
table_ITS_ASV_Rolling_raw <- read.table(paste0(root_path, "ITS_ASV_Rolling_ITS1f_ITS2/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_ASV_Rolling <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_ASV_Rolling_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#Import
table_ITS_ASV_raw <- read.table(paste0(root_path, "ITS_ASV_ITS1f_ITS2/export/OTU.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_ASV <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_ASV_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
#Import
table_ITS_OTU_raw <- read.table(paste0(root_path, "ITS_OTU_ITS1f_ITS2/export/OTU-dn-97.tsv"), 
                                header = TRUE, row.names = 1, sep = "\t", comment.char = "#")
taxonomy_ITS_OTU <- import_qiime2_taxonomy(read.table(paste0(root_path, "ITS_OTU_ITS1f_ITS2/export/taxonomy.tsv"), header = TRUE, row.names = 1, sep = "\t"))
...
true_communities <- as.character(system("ls /mnt/cinqueg/gabriele/work/microbiology/other_analyses/jason/data/ranks_ITS1f_ITS2/*ranks.txt",intern = T))
...
saveRDS(Similarity_scores_2, paste0(root_path, "final_analysis_results_ITS1f_ITS2/similarity_scores.Rds"))
